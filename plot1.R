...
plot1data <- electropower[electropower$Date %in% c("1/2/2007","2/2/2007"),]

# Generate the plot as a histogram (use hist), with red bars and "Global Active Power (kilowatts)" as x-axis label 
# Export the plot to a PNG file with a width of 480 pixels and a height of 480 pixels
png(filename="plot1.png",width= 480,height = 480)
with(plot1data, hist(plot1data$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)"))
dev.off() 
